...
INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, role_id, enabled) VALUES (14, '侍 テスト', 'サムライ テスト', '101-0022', '東京都千代田区神田練塀町300番地', '090-1234-5678', 'test.samurai@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 2, true);
